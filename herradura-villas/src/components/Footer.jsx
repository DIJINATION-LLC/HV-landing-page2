    ...
    <footer className={`${styles.flexCenter} bg-yaleblue w-full py-[50px]`}>
        ...
        <div className={`${styles.boxWidth} w-full flex flex-col gap-[50px] xs:px-0 px-2 sm:px-2`}>
            ...
            <div className="flex xs:flex-row flex-col gap-5">
                <div className="flex flex-col xs:w-1/3 w-full gap-4">
                ...
                <div className="flex flex-col xs:w-1/3 w-full justify-between xs:h-[35vh] gap-4">
                    <div className="flex flex-col xs:gap-3 gap-2">
                    ...
                    <div className="flex flex-col xs:gap-3 gap-2">
                        ...
                        <a href='tel:4802699484' className={`${styles.paragraph} text-white hover:text-goldenbrown`}>(480) 269-9484</a>
                    </div>
